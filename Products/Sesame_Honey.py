...
def create_sesame_honey_content(window):
    items = load_items()
    sesame_honey_price = items["Sesame Honey"]["price"]
    sesame_honey_stock = items["Sesame Honey"]["stock"]
    print("Creating Sesame Honey content...")
    for widget in window.winfo_children():
        widget.destroy()
