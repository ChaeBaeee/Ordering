...
ASSETS_PATH = OUTPUT_PATH / Path("../assets/frame9")  # Correct the path to assets
...
def create_buffalo_wings_content(window):
    ...
    buffalo_wings_price = items["Buffalo Wings"]["price"]  # Get the price of Buffalo Wings
    buffalo_wings_stock = items["Buffalo Wings"]["stock"]  # Get the stock of Buffalo Wings
    ...
    canvas.create_text(
        ...
        417.876708984375,
        anchor="nw",
        text=f"Php {buffalo_wings_price}",  # Use the dynamic price
        fill="#FFFFFF",
        font=("Abril Fatface", 20 * -1)
    )
