...
def create_payment_method_content(window):
  ...
  # Update command
    ...
    window.button_images = [button_image_1, button_image_2, button_image_3, button_image_4]  # Keep a reference to the images

# Comment out or remove the following lines to prevent this script from running when imported:
# window = Tk()
